...
// 3) 제출된 데이터(Parameter) 꺼내기
// 4) 필요한 로직 처리
// 5) 응답 형태 지정(setContentType)
// 6) 응답용 스트림 얻어오기
// 7) html 코드 출력하기

// 어노테이션(Annotaion) : 컴파일러가 읽는 주석(설명)

// @WebServlet("/연결할 요청 주소") 어노테이션
// - 해당 클래스를 Servlet으로 등록하고
//	() 내부에 작성된 주소 요청시 해당 클래스와 연결
...
public class ExampleServlet2 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		case "카푸치노" : price = 1000; break;
		case "카페라떼" : price = 2000; break;
		case "토피넛라떼" : price = 3000; break;
		case "캬라멜마끼야또" : price = 4000; break;
		}
