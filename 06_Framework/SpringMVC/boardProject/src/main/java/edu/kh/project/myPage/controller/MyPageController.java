...
public class MyPageController {
	...
	@Autowired 	// 등록된 bean중 타입 일치(또는 상속 관계)
				// 하는 bean을 의존성 주입(DI)
	...
	public String profile() {
		// /WEB_INF/views/myPage/myPage-profile.jsp (forward)
	 ...
	 * @param loginMember : 로그인 한 회원 정보가 담긴 객체(Session) -> 로그인 한 회원 번호를 얻어와 SQL 조건으로 사용
	 * @return
	 */
	...
	public String info(Member updateMember, String[] memberAddress, RedirectAttributes ra, 
		...
		if(result > 0) { // 성공 시
			...
			// session 가지고 화면 출력 중인데 DB만 바꾸면 되겠나?
