...
//		System.out.println("암호화된 비밀번호 : " + temp);
		...
		// 2) Service에서 bcrypt.matches(평문, 암호문) 메서드를 이용해서
...
//		System.out.println(inputMember);
		...
		// -> Connection 역할을 하는 SqlSessionTemplate이 Bean으로 등록 됨
	...
	// [주의사항]
	// servlet-context.xml에 tx:annotaion-driven 태그가 존재해야 한다.
	// ------------------------------------------------------------------
