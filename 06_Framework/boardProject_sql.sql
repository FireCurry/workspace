...
-- 계정 생성
CREATE USER spring_km_seok IDENTIFIED BY spring1234;

-- 권한 부여
GRANT CONNECT, RESOURCE, CREATE VIEW TO spring_km_seok;

-- 객체 생성 공간 할당
ALTER USER spring_km_seok DEFAULT TABLESPACE "A230724"
...
-- 샘플 계정 추가
INSERT INTO "MEMBER"
VALUES(SEQ_MEMBER_NO.NEXTVAL, 'member01@naver.com', 'pass01', '회원1', '01012341234', '04540^^^서울시 중구 남대문로 120^^^2층', 
...
UPDATE "MEMBER"
SET MEMBER_PW = '$2a$10$T.8EHdhak0vxjZF7DtW2fu8ruezpMDTYHRiR4Dnl0xJlnfS6icCUu'
WHERE MEMBER_NO = 1;
