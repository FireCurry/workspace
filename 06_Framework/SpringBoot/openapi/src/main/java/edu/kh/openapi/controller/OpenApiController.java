...
public class OpenApiController {
	...
	public String ex2(Model model, @RequestParam(value = "regionName", required = false, defaultValue = "서울") String regionName ) throws IOException, JSONException {
		...
		// 인증키
		final String serviceKey = "dZKmt6uLu%2Fb2KPn9P6DWxYguHvqc%2F86%2BzSl2CtQYwSWCN%2BUAjmJpSLYp6On2r9XKp%2FleP1Sk%2BkecXO77E4g3vg%3D%3D";
        ...
        // item 변수에 담긴 JSON 데이터를 하나하나를 Map으로 변경한 후
        // List에 추가
	...
	@GetMapping("ex3")
	public String ex3(Model model) throws IOException{
		String requestUrl = "http://apis.data.go.kr/B552584/ArpltnInforInqireSvc/getCtprvnRltmMesureDnsty";
		String serviceKey = "dZKmt6uLu%2Fb2KPn9P6DWxYguHvqc%2F86%2BzSl2CtQYwSWCN%2BUAjmJpSLYp6On2r9XKp%2FleP1Sk%2BkecXO77E4g3vg%3D%3D";
