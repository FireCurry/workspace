...
-- 다음 시퀀스 번호로 수정
UPDATE TB_TEST SET TEST_NO = SEQ_TEST_NO.NEXTVAL WHERE TEST_NO = (SELECT MIN(TEST_NO) FROM TB_TEST);
--> 125 -> 140
SELECT * FROM TB_TEST;
...
-- 인덱스 사용 X
SELECT * FROM TB_INDEX_TEST
WHERE TEST_ID = 'TEST500000'; -- 21/19/18ms

-- 인덱스 사용 O
SELECT * FROM TB_INDEX_TEST
WHERE TEST_NO = 500000; -- 3/2/1/0ms