...
ALTER TABLE DEPT_COPY ADD 
CONSTRAINT LOCATION_ID_CK CHECK(LOCATION_ID IN ('L1', 'L2', 'L3', 'L4', 'L5'));
...
ALTER TABLE DEPT_COPY DROP
CONSTRAINT LOCATION_ID_CK;

-- NOT NULL 제거 시 MODIFY 사용
ALTER TABLE DEPT_COPY MODIFY
DEPT_ID CONSTRAINT SYS_C0014061 NULL;

ALTER TABLE DEPT_COPY MODIFY
LOCATION_ID CONSTRAINT SYS_C0014062 NULL;

ALTER TABLE DEPT_COPY MODIFY
DEPT_TITLE CONSTRAINT SYS_C0014115 NULL;
